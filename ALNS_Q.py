...
class ALNS_QL:
    ...
    def run(
        ...
        for it in range(1, max_iterations + 1):
            ...
            # Reward = reduction in fitness achieved (positive = good).
            # We measure against current BEFORE the accept step so that
            # the reward is tied to the candidate, not the acceptance decision.
            reward = current.fitness - candidate.fitness   # before update to current
